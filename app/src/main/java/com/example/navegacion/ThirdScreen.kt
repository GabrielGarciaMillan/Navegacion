...
import com.example.navegacion.databinding.FragmentThirdScreenBinding
...
class ThirdScreen : Fragment() {
    ...
    override fun onCreateView(
        ...
        /*
        arguments?.let {
             recibido = it.getString("PARAMETER").toString()
        }
        */
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tVInvocado.text =  binding.tVInvocado.text.toString() + " " + args.origen
    }
